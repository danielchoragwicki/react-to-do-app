import {addTodo, findById, toggleTodo, updateTodo, removeTodo, filterTodos, sortTodos} from './todoHelpers'
...
test('sortTodos should sort an items by priority', () => {
  const startTodos = [
    {id:1, name: 'one', isComplete: false, priority: 1},
    {id:2, name: 'two', isComplete: false, priority: 0},
    {id:3, name: 'three', isComplete: false, priority: 2}
  ]
  const expectedTodos = [
    {id:3, name: 'three', isComplete: false, priority: 2}
    {id:1, name: 'one', isComplete: false, priority: 1},
  ...
  const result = sortTodos(startTodos)

  expect(result).toEqual(expectedTodos)
})

test('sortTodos should not mutate the original array', () => {
  const startTodos = [
    {id:1, name: 'one', isComplete: false, priority: 1},
    {id:2, name: 'two', isComplete: false, priority: 0},
    {id:3, name: 'three', isComplete: false, priority: 2}
